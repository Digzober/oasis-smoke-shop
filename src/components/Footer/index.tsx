      ...
      <div className="newsletter-band bg-mint py-10 md:py-14 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <h3 className="font-bebas text-3xl md:text-4xl text-navy mb-1">
              STAY IN THE LOOP
            </h3>
            <p className="font-inter text-sm md:text-base text-navy/70">
          ...
          <form className="newsletter-wrapper flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            ...
            <button
              type="submit"
              className="newsletter-submit bg-navy text-white font-bebas text-lg tracking-wider py-4 px-8 rounded-lg hover:bg-orange transition-colors duration-300"
            >
              SUBSCRIBE
            </button>
          </form>
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                ...
                className="social-icon w-11 h-11 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-yellow hover:text-navy transition-colors cursor-pointer"
              >
